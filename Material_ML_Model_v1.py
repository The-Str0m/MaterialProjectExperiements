...
model = RandomForestRegressor(n_estimators=1000, random_state=6942)
...
#random forest regressor, magpie featurizer, basic data clean-up
#mae is 0.6103980689600278, r^2 is 0.6819538197547829
